 ...
 * verified AGAINST.  By default that is the vendored harness checkout at
 * <repo>/harness; the A/B snapshot rotation (skill dsh-snapshot-ab)
...
const DSH = process.env.DSH_SOURCE || fileURLToPath(new URL('../../harness', import.meta.url))
