...
- **Host-mediated refresh** — the browser refetches after the plugin-owned long poll or Connection reset; it never consumes Hub WebSocket events directly.
