        ...
        try {
            ...
            for (const provider of providers) {
                ...
                if (disposed)
                    return;
                try {
                    const dispose = llm.registerAdapter([variantId], new ImageInputVariantAdapter(ctx, llm, upstream, provider.name, getRuntime, new EvidenceCache(EVIDENCE_CACHE_LIMIT)));
