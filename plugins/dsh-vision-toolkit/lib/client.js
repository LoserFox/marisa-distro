...
const en = {
    ...
    providerPreset: 'Service preset',
    presetZen: 'OpenCode Zen · MiMo 2.5 Free',
    presetGlm: 'BigModel · GLM-4.6V-Flash',
    presetCustom: 'Custom OpenAI-compatible service',
    authMode: 'Authentication',
    anonymous: 'No account or API key',
    credentialAuth: 'DSH Credential',
    zenGuide: 'Free anonymous access with no account or API key. OpenCode states that this offer is time-limited and free-period data may be used to improve the model; do not send sensitive images.',
    glmGuide: 'GLM-4.6V-Flash is a free official endpoint. Register, create an API key, save it as ZHIPU_API_KEY in Models credentials, then save this preset.',
    registerGlm: 'Register or sign in',
    createGlmKey: 'Create API key',
    healthCredentialAnonymous: 'Anonymous provider; no user credential is required.',
    baseUrl: 'Base URL',
    apiKey: 'API key',
...
const zh = {
    ...
    providerPreset: '服务预设',
    presetZen: 'OpenCode Zen · MiMo 2.5 免费版',
    presetGlm: '智谱 BigModel · GLM-4.6V-Flash',
    presetCustom: '自定义 OpenAI 兼容服务',
    authMode: '鉴权方式',
    anonymous: '无需账号或 API Key',
    credentialAuth: 'DSH Credential',
    zenGuide: '免注册、免 API Key 的免费服务。OpenCode 说明该免费活动为限时提供，免费期数据可能用于改进模型；请勿发送敏感图片。',
    glmGuide: 'GLM-4.6V-Flash 是官方免费接口。请先注册并创建 API Key，在“模型”设置的凭据管理中保存为 ZHIPU_API_KEY，再保存此预设。',
    registerGlm: '注册或登录',
    createGlmKey: '创建 API Key',
    healthCredentialAnonymous: '匿名服务，无需任何用户凭据。',
    baseUrl: 'API 地址',
    apiKey: 'API 密钥',
...
function providerPresetOf(draft) {
    if (draft.baseUrl === 'https://opencode.ai/zen/v1'
        && draft.model === 'mimo-v2.5-free'
        && draft.authMode === 'none')
        return 'zen';
    if (draft.baseUrl === 'https://open.bigmodel.cn/api/paas/v4'
        && draft.model === 'glm-4.6v-flash'
        && draft.authMode === 'credential')
        return 'glm';
    return 'custom';
}
function selectProviderPreset(draft, preset) {
    if (preset === 'zen') {
        return {
            ...draft,
            providerPreset: 'zen',
...
function draftOf(value) {
    ...
    return { providerPreset: providerPresetOf(draft), ...draft };
}
...
function healthDetail(name, detail, t) {
    ...
    if (detail === 'Anonymous provider; no user credential is required')
        return t('healthCredentialAnonymous');
...
function LoadedSettings({ controller, t }) {
    ...
    const save = () => {
        try {
            ...
            const credentialValue = draft.authMode === 'none' || apiKey.length === 0 ? undefined : apiKey.trim();
    ...
    const manualUpdateCommand = `dsh plugin --profile ${manualUpdateProfile} add @dsh-external/dsh-vision-toolkit@latest --registry=https://registry.npmjs.org/`;
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dvt-settings", children: [(0, jsx_runtime_1.jsx)("div", { className: "dvt-alert notice", children: t('externalNotice') }), !snapshot.writable ? (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert warning", children: t('readOnly') }) : null, draftError === undefined ? null : (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert error", children: draftError }), state.error === undefined ? null : (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert error", children: state.error }), state.message === 'saved' ? (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert success", children: t('saved') }) : null, state.message === 'restarting' && state.restart !== undefined ? (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert success", children: t('restarting', { version: state.restart.toVersion }) }) : null, state.message === 'manual-restart-required' && state.restart !== undefined ? (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert success", children: t('manualRestartRequired', { version: state.restart.toVersion }) }) : null, snapshot.runtime.lastError === undefined ? null : (0, jsx_runtime_1.jsxs)("div", { className: "dvt-alert error", children: [(0, jsx_runtime_1.jsx)("strong", { children: runtimeErrorTitle }), (0, jsx_runtime_1.jsx)("span", { children: snapshot.runtime.lastError })] }), (0, jsx_runtime_1.jsxs)("section", { className: "dvt-panel dvt-essential", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dvt-panel-title", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { children: t('provider') }), (0, jsx_runtime_1.jsx)("p", { children: t('providerHint') })] }), (0, jsx_runtime_1.jsx)("span", { className: `dvt-badge ${draft.authMode === 'none' || snapshot.credential.configured ? 'ok' : 'error'}`, children: draft.authMode === 'none' ? t('anonymous') : snapshot.credential.configured ? t('configured') : t('missing') })] }), (0, jsx_runtime_1.jsx)("p", { className: "dvt-tutorial-link", children: (0, jsx_runtime_1.jsx)("a", { href: tutorialUrl, target: "_blank", rel: "noreferrer", children: t('groqTutorial') }) }), (0, jsx_runtime_1.jsxs)("div", { className: "dvt-form-grid", children: [(0, jsx_runtime_1.jsx)(Field, { label: t('providerPreset'), children: (0, jsx_runtime_1.jsxs)("select", { disabled: !snapshot.writable || busy, value: draft.providerPreset, onChange: (event) => { setDraft(current => current === undefined ? current : selectProviderPreset(current, event.target.value)); if (event.target.value === 'zen')
                                        setApiKey(''); }, children: [(0, jsx_runtime_1.jsx)("option", { value: "zen", children: t('presetZen') }), (0, jsx_runtime_1.jsx)("option", { value: "glm", children: t('presetGlm') }), (0, jsx_runtime_1.jsx)("option", { value: "custom", children: t('presetCustom') })] }) }), draft.providerPreset === 'custom' ? (0, jsx_runtime_1.jsx)(Field, { label: t('authMode'), children: (0, jsx_runtime_1.jsxs)("select", { disabled: !snapshot.writable || busy, value: draft.authMode, onChange: (event) => { update('authMode', event.target.value); if (event.target.value === 'none')
                                        setApiKey(''); }, children: [(0, jsx_runtime_1.jsx)("option", { value: "none", children: t('anonymous') }), (0, jsx_runtime_1.jsx)("option", { value: "credential", children: t('credentialAuth') })] }) }) : null, (0, jsx_runtime_1.jsx)(Field, { label: t('protocol'), children: (0, jsx_runtime_1.jsxs)("select", { disabled: !snapshot.writable || busy, value: draft.protocol, onChange: (event) => { update('protocol', event.target.value); }, children: [(0, jsx_runtime_1.jsx)("option", { value: "openai", children: "OpenAI Chat Completions" }), (0, jsx_runtime_1.jsx)("option", { value: "anthropic", children: "Anthropic Messages" })] }) }), (0, jsx_runtime_1.jsx)(Field, { label: t('baseUrl'), children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Input, { disabled: !snapshot.writable || busy, value: draft.baseUrl, onChange: (event) => { update('baseUrl', event.target.value); } }) }), (0, jsx_runtime_1.jsx)(Field, { label: t('model'), children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Input, { disabled: !snapshot.writable || busy, value: draft.model, onChange: (event) => { update('model', event.target.value); } }) }), draft.authMode === 'credential' ? (0, jsx_runtime_1.jsx)(Field, { label: t('apiKey'), hint: keyLocked ? t('apiKeyLocked') : snapshot.credential.source === undefined ? t('apiKeyHint') : `${t('apiKeyHint')} ${t('sourceHint', { source: t('source'), value: credentialSource(snapshot.credential.source, t) })}`, children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Input, { "aria-label": t('apiKey'), type: "password", autoComplete: "new-password", disabled: busy || keyLocked, placeholder: snapshot.credential.configured ? t('apiKeyPlaceholderConfigured') : t('apiKeyPlaceholderMissing'), value: apiKey, onChange: (event) => { setApiKey(event.target.value); setDraftError(undefined); } }) }) : null] }), draft.providerPreset === 'zen' ? (0, jsx_runtime_1.jsx)("div", { className: "dvt-provider-guide", children: t('zenGuide') }) : null, draft.providerPreset === 'glm' ? (0, jsx_runtime_1.jsxs)("div", { className: "dvt-provider-guide", children: [(0, jsx_runtime_1.jsx)("span", { children: t('glmGuide') }), (0, jsx_runtime_1.jsxs)("nav", { children: [(0, jsx_runtime_1.jsx)("a", { href: "https://bigmodel.cn/console/overview", target: "_blank", rel: "noreferrer", children: t('registerGlm') }), (0, jsx_runtime_1.jsx)("a", { href: "https://bigmodel.cn/usercenter/proj-mgmt/apikeys", target: "_blank", rel: "noreferrer", children: t('createGlmKey') })] })] }) : null] }), (0, jsx_runtime_1.jsxs)("div", { className: "dvt-save-row", children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "primary", disabled: !canSave || busy, onClick: save, children: state.action === 'save' ? t('saving') : t('save') }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "outline", disabled: busy, onClick: () => { void controller.load(); }, children: t('reload') })] }), (0, jsx_runtime_1.jsxs)("section", { className: "dvt-panel", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dvt-panel-title", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { children: t('health') }), (0, jsx_runtime_1.jsx)("p", { children: t('connectionHint') })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dvt-actions", children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { size: "sm", variant: "outline", disabled: busy || !snapshot.runtime.ready, onClick: () => { void controller.runHealth('health'); }, children: state.action === 'health' ? t('testing') : t('runHealth') }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { size: "sm", variant: "outline", disabled: busy || !snapshot.runtime.ready, onClick: () => { void controller.runHealth('connection'); }, children: state.action === 'connection' ? t('testing') : t('testConnection') }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { size: "sm", variant: "primary", disabled: busy || !snapshot.runtime.ready, onClick: () => { void controller.runHealth('model'); }, children: state.action === 'model' ? t('testingModel') : t('testModel') })] })] }), (0, jsx_runtime_1.jsx)("p", { className: "dvt-muted", children: t('saveBeforeTesting') }), state.health === undefined ? (0, jsx_runtime_1.jsx)("p", { className: "dvt-muted", children: t('notTested') }) : (0, jsx_runtime_1.jsx)("div", { className: "dvt-health-grid", children: Object.entries(state.health.checks).map(([name, check]) => {
...
@media(max-width:720px){.dvt-settings-footer{display:grid}.dvt-release{width:auto}.dvt-form-grid,.dvt-update-grid{grid-template-columns:1fr}.dvt-metrics{grid-template-columns:1fr}.dvt-artifact-meta{align-items:flex-start;flex-direction:column}.dvt-panel-title,.dvt-provider-guide{flex-direction:column}}
`;
