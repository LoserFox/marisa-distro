...
declare module 'cordis' {
  interface Context {
    ...
    /** rc6 compatibility name used by current external client plugins. */
    inputTriggers: import('./contract.ts').SlashServiceContract
  }
}
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => { return ctx.locale.register(MENU_NS, { zh, en }) }, 'ui-slash: menu dictionaries')
